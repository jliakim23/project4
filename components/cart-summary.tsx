...
export function CartSummary() {
  ...
  const shippingAmount = cartCount! > 0 ? 10 : 0
 ...
 setIsLoading(false)
  ...
  return (
    <section
      ...
      className="mt-16 rounded-lg border-2 border-gray-200 bg-gray-50 px-4 py-6 shadow-md white sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8"
    >
      ...
      <dl className="mt-6 space-y-4">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
          <dt className="text-base font-medium">$ {totalAmount}</dt>
